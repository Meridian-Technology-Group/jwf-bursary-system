...
| A3 | reopened | [#277](https://github.com/Meridian-Technology-Group/jwf-bursary-system/pull/277) | First pass shipped a parity test only + escalated; reopened with the error screenshot as new evidence |
