...
| Admin Console (legacy, discovery) | [ADMIN.md](../../discovery/admin-console.md) | Legacy Grant Tracker admin console structure — as-is discovery baseline, not the system we built |
