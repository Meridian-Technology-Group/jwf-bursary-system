...
| C16 | **Mortgage-free rent add-back** (new, 24 Sep). The model offers "Full — mortgage-free (+100%)" rent add-back, which an assessor would select for a family owning its home outright. The mapping doc did not address it. | Apply `FULL_MORTGAGE_FREE` where the home has a value and no mortgage (4 accounts) | Nothing: global rule | Report — for her to confirm |
