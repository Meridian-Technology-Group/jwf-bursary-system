...
| C13 | **The 2025/26 row on the ASSESSMENT ADMIN tab.** Her 21 Sep table shows a 2025/26 financial row "from GT fields". That row is earlier-year **option 1** (£200), not the current-year scope. Does she want it with the first batch? | Not built; the tab shows 2026-27 only | Nothing (additive later) | Reply of 21 Sep |
