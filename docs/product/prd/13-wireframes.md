...
- **[APPLICATION.md](../../archive/specs/applicant-form.md)** — every input component in the applicant portal, section by section (archived build spec)
- **[ADMIN.md](../../archive/discovery/admin-console.md)** — legacy Grant Tracker admin console screens and workflows (discovery baseline for the replacement)
...
The following sections map directly to the existing form documented in [APPLICATION.md](../../archive/specs/applicant-form.md), with noted improvements:
